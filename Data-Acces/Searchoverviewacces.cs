...
public class SearchoverviewAcces
{
    ...
    internal List<Flight> SearchFlights(SearchoverviewBuisness search)
    {
    ...
    private List<Flight> ExecuteFlightSearch(string destination, string origin, DateTime date)
    {
